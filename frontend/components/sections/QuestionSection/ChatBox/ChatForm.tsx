...
export default function ChatForm({ setChatHistory, generateAIResponse } : ChatFormProps ) {
    ...
    return (
        <form action="#" className="flex items-center gap-3 w-full" onSubmit={handleFormSubmit}>
            ...
            className="message-input placeholder-black flex-1 min-w-0 px-4 py-2 border border-red-300 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none" 
            required
            />
