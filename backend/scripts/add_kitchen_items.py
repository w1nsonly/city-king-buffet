# restaurant/scripts/add_kitchen_items.py
...
from restaurant.models import KitchenItem, KitchenCategory

# Dictionary of menu categories
kitchen_items = {
    "Appetizers": [
        {"id_number": 1, "name": "Spring Roll (2)", "price": 4.95},
        {"id_number": 2, "name": "Egg Roll", "price": 2.00},
        {"id_number": 3, "name": "Fried Biscuit (10)", "price": 5.95},
        {"id_number": 4, "name": "Fried Shrimp (11)", "price": 7.25},
        {"id_number": 5, "name": "Fried or Steamed Dumplings (8)", "price": 7.95},
        {"id_number": 6, "name": "Crab Rangoon (8)", "price": 6.95},
        {"id_number": 7, "name": "Potato Skin (6)", "price": 6.95},
        {"id_number": 8, "name": "Fried Wonton (12)", "price": 5.95},
        {"id_number": 9, "name": "Chicken Teriyaki (5)", "price": 6.95},
        {"id_number": 9.5, "name": "Corn Nuggets (18)", "price": 6.95},
    ],
    "Soups": [
        {"id_number": 10, "name": "Wonton Soup", "price": 5.50},
        {"id_number": 11, "name": "Egg Drop Soup", "price": 5.50},
        {"id_number": 12, "name": "Chicken Noodle or Rice Soup", "price": 5.50},
        {"id_number": 13, "name": "Hot & Sour Soup", "price": 6.50},
        {"id_number": 14, "name": "Vegetable Soup", "price": 5.50},
        {"id_number": 15, "name": "House Special Soup", "price": 7.75},
        {"id_number": 16, "name": "Seafood Soup", "price": 7.75},
    ],
    "Chow Mein": [
    ...
    "Mei Fun": [
        ...
        {"id_number": 42, "name": "Singapore Mei Fun", "price": 10.25, "is_spicy": True},
    ],
    "Fried Rice": [
    ...
    "Vegetable": [
        ...
        {"id_number": 59, "name": "Broccoli in Garlic Sauce", "price": 8.99, "is_spicy": True},
        {"id_number": 60, "name": "Mixed Vegetable in Garlic Sauce", "price": 8.99, "is_spicy": True},
    ...
    "Shrimp": [
        ...
        {"id_number": 65, "name": "Shrimp W. Curry Sauce", "price": 10.50, "is_spicy": True},
        {"id_number": 66, "name": "Hot & Spicy Shrimp", "price": 10.50, "is_spicy": True},
        {"id_number": 67, "name": "Shrimp W. Garlic Sauce", "price": 10.50, "is_spicy": True},
        {"id_number": 68, "name": "Shrimp W. Cashew Nuts", "price": 10.50},
        {"id_number": 69, "name": "Kung Po Shrimp", "price": 10.50, "is_spicy": True},
        {"id_number": 70, "name": "Shrimp W. Mixed Vegetable", "price": 10.50},
        {"id_number": 70.5, "name": "Coconut Shrimp", "price": 11.50},
        {"id_number": 70.9, "name": "Black Pepper Shrimp", "price": 14.99},
    ],
    "Beef": [
        {"id_number": 71, "name": "Beef w. Broccoli", "price": 10.25},
        {"id_number": 72, "name": "Pepper Steak", "price": 10.25},
        {"id_number": 73, "name": "Kung Po Beef w. Peanut", "price": 10.25, "is_spicy": True},
        {"id_number": 74, "name": "Beef w. Garlic Sauce", "price": 10.25, "is_spicy": True},
        {"id_number": 75, "name": "Beef w. Mixed Vegetables", "price": 10.25},
        {"id_number": 76, "name": "Beef Szechuan Style", "price": 10.25, "is_spicy": True},
        {"id_number": 77, "name": "Beef Hunan Style", "price": 10.25, "is_spicy": True},
    ...
    "Pork": [
        ...
        {"id_number": 81, "name": "Kung Po Pork", "price": 9.95, "is_spicy": True},
        {"id_number": 82, "name": "Pork Hunan Style", "price": 9.95, "is_spicy": True},
        {"id_number": 83, "name": "Pork In Garlic Sauce", "price": 9.95, "is_spicy": True},
    ...
    "Chicken": [
        ...
        {"id_number": 87, "name": "Spicy Curry Chicken", "price": 10.25, "is_spicy": True},
        {"id_number": 88, "name": "Chicken W. Cashew Nuts", "price": 10.25},
        {"id_number": 89, "name": "Chicken In Garlic Sauce", "price": 10.25, "is_spicy": True},
        {"id_number": 90, "name": "Chicken Teriyaki", "price": 10.25},
        {"id_number": 91, "name": "Sweet & Sour Chicken", "price": 10.25},
        {"id_number": 92, "name": "Kung Po Chicken", "price": 10.25, "is_spicy": True},
        {"id_number": 93, "name": "Moo Gao Gai Pan", "price": 10.25},
        {"id_number": 94, "name": "Chicken W. Mixed Vegetable", "price": 10.25},
        {"id_number": 95, "name": "Chicken W. Broccoli In Garlic Sauce", "price": 10.25},
        {"id_number": 96, "name": "Chicken Hunan Style", "price": 10.25, "is_spicy": True},
        {"id_number": 97, "name": "Chicken Szechuan Style", "price": 10.25, "is_spicy": True},
    ...
    "Lunch Combos": [
        ...
        {"id_number": "L15", "name": "Kung Po Chicken", "price": 8.25, "is_spicy": True},
        {"id_number": "L16", "name": "Shrimp W. Garlic Sauce", "price": 8.25, "is_spicy": True},
        {"id_number": "L17", "name": "Chicken W. Garlic Sauce", "price": 8.25, "is_spicy": True},
        {"id_number": "L18", "name": "Szechuan Spice Shrimp", "price": 8.25, "is_spicy": True},
        {"id_number": "L19", "name": "Sesame Beef", "price": 8.25},
        {"id_number": "L20", "name": "General Tso's Chicken", "price": 8.25, "is_spicy": True},
        {"id_number": "L21", "name": "Chicken W. Cashew Nuts", "price": 8.25},
        {"id_number": "L22", "name": "Beef Hunan Style", "price": 8.25, "is_spicy": True},
        {"id_number": "L23", "name": "Beef Szechuan Style", "price": 8.25, "is_spicy": True},
        {"id_number": "L24", "name": "Chicken Hunan Style", "price": 8.25, "is_spicy": True},
        {"id_number": "L25", "name": "Chicken Szechuan Style", "price": 8.25, "is_spicy": True},
    ...
    "Special Combos": [
        ...
        {"id_number": "C15", "name": "Kung Po Chicken", "price": 10.25, "is_spicy": True},
        {"id_number": "C16", "name": "Shrimp W. Garlic Sauce", "price": 10.25, "is_spicy": True},
        {"id_number": "C17", "name": "Chicken W. Garlic Sauce", "price": 10.25, "is_spicy": True},
        {"id_number": "C18", "name": "Szechuan Spice Shrimp", "price": 10.25, "is_spicy": True},
        {"id_number": "C19", "name": "Sesame Beef", "price": 10.25},
        {"id_number": "C20", "name": "General Tso's Chicken", "price": 10.25, "is_spicy": True},
        {"id_number": "C21", "name": "Chicken W. Cashew Nuts", "price": 10.25},
        {"id_number": "C22", "name": "Beef Hunan Style", "price": 10.25, "is_spicy": True},
        {"id_number": "C23", "name": "Beef Szechuan Style", "price": 10.25, "is_spicy": True},
        {"id_number": "C24", "name": "Chicken Hunan Style", "price": 10.25, "is_spicy": True},
        {"id_number": "C25", "name": "Chicken Szechuan Style", "price": 10.25, "is_spicy": True},
    ...
    "Chef Specials": [
        ...
        {"id_number": "S5", "name": "General Tso's Shrimp", "price": 11.95, "is_spicy": True},
        {"id_number": "S6", "name": "Sesame Beef", "price": 12.50},
        {"id_number": "S7", "name": "Sesame Chicken", "price": 10.99},
        {"id_number": "S8", "name": "Hunan Shrimp", "price": 11.50, "is_spicy": True},
        {"id_number": "S9", "name": "Dragon & Phoenix", "price": 11.75},
        {"id_number": "S10", "name": "General Tso's Chicken", "price": 11.50, "is_spicy": True},
        {"id_number": "S11", "name": "Orange Chicken", "price": 11.59, "is_spicy": True},
        {"id_number": "S12", "name": "Orange Beef", "price": 11.99, "is_spicy": True},
        {"id_number": "S13", "name": "Triple Delight W. Garlic Sauce", "price": 10.75, "is_spicy": True},
        {"id_number": "S14", "name": "Kung Po Triple Delight", "price": 11.75, "is_spicy": True},
        {"id_number": "S15", "name": "Hunan Triple", "price": 11.75, "is_spicy": True},
        {"id_number": "S16", "name": "Shrimp W. Szechuan Sauce", "price": 11.75, "is_spicy": True},
...
def main():
    for category_name, items in kitchen_items.items():
        # categories were created by category script; fall back to get_or_create
        cat, _ = KitchenCategory.objects.get_or_create(name=category_name)

        for item in items:
            # normalize fields
            raw_id = item.get("id_number")
            id_number = str(raw_id) if raw_id is not None else None
            name = item["name"].strip()
            price = Decimal(str(item["price"]))
            is_spicy = bool(item.get("is_spicy", False))

            # build lookup (use category + id_number if present, else category + name)
            if id_number:
                lookup = {"category": cat, "id_number": id_number}
            else:
                lookup = {"category": cat, "name": name}

            # always set full defaults (FK instance, not string)
            defaults = {
                "category": cat,
                "name": name,
                "price": price,
                "is_spicy": is_spicy,
                "id_number": id_number,  # can be None
            }

            obj, created = KitchenItem.objects.update_or_create(**lookup, defaults=defaults)
            
            print(("Created" if created else "Updated") + f": {obj}")
